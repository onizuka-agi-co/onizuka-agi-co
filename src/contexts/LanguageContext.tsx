...
const translations = {
  ja: {
    ...
    'contact.hiringDescription': 'ONIZUKA AGI Co. は、自律AIの未来をつくる優秀な研究者・エンジニアを募集しています。',
  ...
  en: {
    ...
    'contact.hiringPrefix': 'We\'re',
    'contact.hiringHighlight': 'Hiring',
    'contact.hiringDescription': 'ONIZUKA AGI Co. is looking for exceptional researchers and engineers to build the future of autonomous AI.',
    'contact.position1Title': 'Founding Engineer',
    'contact.position2Title': 'AI Researcher',
    'contact.position3Title': 'Open Application',
    'contact.locationRemote': 'Remote',
