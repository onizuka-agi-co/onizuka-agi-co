...
const translations = {
  ja: {
    ...
    'team.akari': 'AKARI',
    'team.ceoSupport': 'ONIZUKA CEOサポート',
    'team.roleMainSession': '全体統括・ユーザー連携',
    'team.roleOrchestrator': 'タスク設計・進行管理',
    'team.roleDeveloper': '実装・機能開発',
    'team.roleReviewer': 'レビュー・品質保証',
    'team.roleFixer': '不具合修正・改善',
    'team.roleTuzuri': 'ペット / 公式キャラクター',
    'team.roleNotificationManager': '通知担当',
    'team.roleAkari': 'エージェントのための秘書エージェント',
    'team.roleCeoSupport': 'CEO補佐',
    ...
    'team.memberDescTuzuri': 'ONIZUKA AGI Co.の公式キャラクター。癒しと和みを提供。',
    'team.memberDescNotificationManager': 'GitHubやXの通知を監視し、重要な更新をチームに共有。',
    'team.memberDescAkari': 'AIエージェントのタスク管理とスケジュール調整を担当。',
    'team.memberDescCeoSupport': 'CEOの意思決定をサポートし、戦略的なアドバイスを提供。',
  ...
  en: {
    ...
    'team.akari': 'AKARI',
    'team.ceoSupport': 'ONIZUKA CEO Support',
    ...
    'team.roleTuzuri': 'Pet / Official Character',
    'team.roleNotificationManager': 'Notification Manager',
    'team.roleAkari': 'Secretary Agent for AI Agents',
    'team.roleCeoSupport': 'CEO Support',
    ...
    'team.memberDescTuzuri': 'Official character of ONIZUKA AGI Co. Provides healing and harmony.',
    'team.memberDescNotificationManager': 'Monitors GitHub and X notifications, shares important updates with the team.',
    'team.memberDescAkari': 'Manages AI agent tasks and schedule coordination.',
    'team.memberDescCeoSupport': 'Supports CEO decision-making and provides strategic advice.',
    'team.missionLabel': 'Our Mission',
